...
<p align="center">
  <img src="docs/assets/readme/demo-v2.gif" alt="browsa demo: attach the current page and ask, follow up on a selected phrase, explain a selection in place, read a video with a clickable timeline, and watch diagrams and a 3D protein structure render inside the reply" width="720" />
</p>
<p align="center">
