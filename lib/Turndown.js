...
var commonmark_rules_default = rules;
...
var collapse_whitespace_default = collapseWhitespace;
...
var html_parser_default = canParseHTMLNatively() ? root.DOMParser : createHTMLParser();
...
var _htmlParser;
function htmlParser() {
  _htmlParser = _htmlParser || new html_parser_default();
  return _htmlParser;
}
...
function TurndownService(options) {
  ...
  var defaults = {
    rules: commonmark_rules_default,
    headingStyle: "setext",
    hr: "* * *",
    bulletListMarker: "*",
