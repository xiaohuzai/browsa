...
const DEFAULTS = {
  providers: {
    hermes:       { type: 'agent', baseUrl: 'http://101.47.17.208:8642', apiKey: '', model: '', stream: true, isHermes: true, useRunsApi: true, temperature: null, maxTokens: 0 },
    'claude-code':{ type: 'agent', baseUrl: '',                          apiKey: '', model: '', stream: true, isHermes: false, temperature: null, maxTokens: 0 },
