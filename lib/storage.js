...
const DEFAULTS = {
  providers: {
    hermes:       { type: 'agent', baseUrl: 'http://101.47.17.208:8642', apiKey: '', model: '', stream: true, useResponsesApi: true  },
    'claude-code':{ type: 'agent', baseUrl: '',                          apiKey: '', model: '', stream: true, useResponsesApi: false },
    compatible:   { type: 'llm',   baseUrl: '',                          apiKey: '', model: '', stream: true, useResponsesApi: false },
  },
