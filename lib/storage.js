...
const DEFAULTS = {
  providers: {
    hermes: { baseUrl: 'http://101.47.17.208:8642', apiKey: '', defaultModel: 'hermes-agent', stream: true, useResponsesApi: true, useRunsApi: false },
    'claude-code': { baseUrl: 'http://localhost:8000', apiKey: '', defaultModel: 'claude-sonnet-4-6', stream: true, useResponsesApi: false, useRunsApi: false }
  },
