...
const DEFAULTS = {
  providers: {
    hermes:       { type: 'agent', baseUrl: '',                          apiKey: '', model: '', stream: true, isHermes: true, apiStyle: 'chat', temperature: null, maxTokens: 0 },
    compatible:   { type: 'llm',   baseUrl: '',                          apiKey: '', model: '', stream: true, isHermes: false, apiStyle: 'chat', temperature: null, maxTokens: 0 },
    anthropic:    { type: 'llm',   baseUrl: '',                          apiKey: '', model: '', stream: true, isHermes: false, apiStyle: 'anthropic', temperature: null, maxTokens: 0 },
  },
