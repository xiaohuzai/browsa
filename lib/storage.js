...
const DEFAULTS = {
  ...
  autoAttachPage: true,
  // Page size limits (chars). Keep these in sync with lib/page-extractor.js defaults.
  maxHtmlChars: 500_000,   // cap raw outerHTML read from the page
  maxTextChars: 500_000    // cap stripped text sent to the model
};
