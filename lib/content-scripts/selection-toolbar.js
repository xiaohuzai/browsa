...
(function () {
  ...
  shadow.innerHTML = `
    <style>
      ...
      /* Ask = primary action: proofreader-red fill, the bar's one loud element */
      .btn-ask {
        background: #e0542c; color: #fff; font-weight: 600;
        box-shadow: 0 2px 8px rgba(224,84,44,0.35);
      }
      .btn-ask:hover { background: #ef5f35; color: #fff; }
      ...
      @media (prefers-color-scheme: light) {
        ...
        .btn-ask { background: #c2410c; color: #fff; box-shadow: 0 2px 8px rgba(194,65,12,0.3); }
        .btn-ask:hover { background: #a93a0b; color: #fff; }
    ...
    <div class="bar" id="bar" role="toolbar" aria-label="${M('toolbarAria', 'browsa quick actions')}">
      <img class="logo" src="${chrome.runtime.getURL('icons/icon16.png')}" alt="browsa" />
      <div class="sep"></div>
      <button class="btn btn-ask" data-action="chat" title="${M('toolbarAsk', 'Ask')}"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"/></svg>${M('toolbarAsk', 'Ask')}</button>
      <div class="sep"></div>
      <button class="btn" data-action="explain" title="${M('toolbarExplain', 'Explain')}"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>${M('toolbarExplain', 'Explain')}</button>
      <button class="btn btn-ico" data-action="translate" aria-label="${M('toolbarTranslate', 'Translate')}" title="${M('toolbarTranslate', 'Translate')}"><svg width="15" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m5 8 6 6"/><path d="m4 14 6-6 2-3"/><path d="M2 5h12"/><path d="M7 2h1"/><path d="m22 22-5-10-5 10"/><path d="M14 18h6"/></svg></button>
      <button class="btn" data-action="summarize" title="${M('toolbarSummarize', 'Summarize')}"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M3 12h18"/><path d="M3 18h12"/></svg>${M('toolbarSummarize', 'Summarize')}</button>
      <div class="sep"></div>
      <button class="btn-close" id="close-btn" aria-label="${M('toolbarHide', 'Hide on this page')}" title="${M('toolbarHide', 'Hide on this page')}"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6L6 18M6 6l12 12"/></svg></button>
    </div>
    <div class="confirm" id="confirm" role="dialog" aria-label="${M('toolbarHideConfirm', 'Confirm')}">
      <div class="confirm-msg">${M('toolbarHideConfirm', 'Hide toolbar on this page?')}<span>${M('toolbarHideHint', "It won't show again until you reload.")}</span></div>
