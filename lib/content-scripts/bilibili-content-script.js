...
async function activeFetchBilibiliVideo() {
  ...
  // Capture audio URL from __playinfo__ — read unconditionally so a meta miss
  // above never loses the audio stream (the transcription/ASR hook).
  const audioUrl = readBilibiliAudioUrl();
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { isBilibiliViewUrl, isBilibiliPlayerUrl, extractBilibiliVideo, installBilibiliInterceptor, md5, wbiSign, activeFetchBilibiliVideo, readBilibiliAudioUrl, fetchBilibiliSubtitle };
}
