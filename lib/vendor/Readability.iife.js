...
Readability.prototype = {
  ...
  _getArticleTitle() {
    ...
    if (curTitleWordCount <= 4 && (!titleHadHierarchicalSeparators || curTitleWordCount != wordCount(
        ...
        if (node.tagName === "DIV") {
          ...
          while (childNode) {
            ...
            if (this._isPhrasingContent(childNode)) {
              ...
              while (fragment.firstChild && this._isWhitespace(fragment.firstChild)) {
                fragment.firstChild.remove();
              }
              while (fragment.lastChild && this._isWhitespace(fragment.lastChild)) {
