...
// own synthesis logic (synthesizeXhsResultFromXhr, still in
// page-extractor.js), not the SITE_CACHES/synthesizeSiteCache dispatch this
// file covers.
...
export function synthesizeBilibiliResult(data, meta) {
  ...
  const text = parts.join('\n\n');
  return makeSynthResult('bilibili', meta, text, byAuthor(data));
}
