...
function installInterceptor() {
  if (typeof window === 'undefined') return false;  // Node, not browser
  if (typeof chrome === 'undefined' || !chrome.runtime) return false;  // not extension context
  ...
  function safeSend(msg) {
    try {
      ...
      // extension context invalidated (e.g. extension reloaded). Drop.
    }
  }
  return true;
}
